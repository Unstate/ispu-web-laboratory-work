...
const SecondLab = () => {
  return (
    <main className="w-full min-h-screen flex flex-col bg-[#181513]">
      ...
      <section className=" text-white text-3xl w-full h-[30%] flex items-center">
        <div className="w-5/6 h-full flex flex-col justify-center gap-16 p-8">
          ...
          <div className="flex justify-start text-xl italic">
            <p className="-rotate-[30]">"Я всегда готов к вызовам и новым целям."</p>
          </div>
        </div>
      ...
      <section className=" w-full h-[15%] flex">
        <div className="h-full w-[50%] bg-[#181513] flex justify-between items-center p-5">
          <ReactSVG src={nike} width={100} height={100} className="fill-white"/>
          <ReactSVG src={paypal} width={100} height={100}  className="fill-white"/>
          <ReactSVG src={openai} width={100} height={100} className="fill-white"/>
          <ReactSVG src={tesla} width={100} height={100} className="fill-white"/>
          <ReactSVG src={binance} width={100} height={100} className="fill-white"/>
        </div>
